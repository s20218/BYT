...
public class Money implements Comparable {
	...
	public String toString() {
		String m = String.valueOf(amount);
		return m.substring(0, m.length() - 2) + "." + m.substring(m.length() - 1) + " " + currency.getName();
	}
	...
	public Money add(Money other) {
		Integer added = this.amount + this.currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
	...
	public Money sub(Money other) {
		Integer subtracted = this.amount - this.currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
		return new Money(subtracted, this.currency);
	}
